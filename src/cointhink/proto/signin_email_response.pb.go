...
func (*SigninEmailResponse) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func init() { proto1.RegisterFile("proto/signin_email_response.proto", fileDescriptor14) }
