...
func (*ScheduleDetailResponse) Descriptor() ([]byte, []int) { return fileDescriptor42, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_detail_response.proto", fileDescriptor42) }
