...
func (Algorun_States) EnumDescriptor() ([]byte, []int) { return fileDescriptor20, []int{0, 0} }
...
func (*Algorun) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func init() { proto1.RegisterFile("proto/algorun.proto", fileDescriptor20) }
