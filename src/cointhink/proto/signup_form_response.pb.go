...
func (*SignupFormResponse) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func init() { proto1.RegisterFile("proto/signup_form_response.proto", fileDescriptor20) }
