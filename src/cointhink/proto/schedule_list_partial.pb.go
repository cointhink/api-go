...
func (*ScheduleListPartial) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_list_partial.proto", fileDescriptor12) }
