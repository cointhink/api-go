...
func (*ScheduleListPartial) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_list_partial.proto", fileDescriptor11) }
