...
func (*ScheduleListPartial) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_list_partial.proto", fileDescriptor5) }
