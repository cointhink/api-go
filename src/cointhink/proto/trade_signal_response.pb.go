...
func (*TradeSignalResponse) Descriptor() ([]byte, []int) { return fileDescriptor29, []int{0} }
...
func init() { proto1.RegisterFile("proto/trade_signal_response.proto", fileDescriptor29) }
