...
func (*AlgorithmListResponse) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func init() { proto1.RegisterFile("proto/algorithm_list_response.proto", fileDescriptor16) }
