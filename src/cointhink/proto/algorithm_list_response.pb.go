...
func (*AlgorithmListResponse) Descriptor() ([]byte, []int) { return fileDescriptor19, []int{0} }
...
func init() { proto1.RegisterFile("proto/algorithm_list_response.proto", fileDescriptor19) }
