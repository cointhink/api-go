...
func (*SessionCreateResponse) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func init() { proto1.RegisterFile("proto/session_create_response.proto", fileDescriptor15) }
