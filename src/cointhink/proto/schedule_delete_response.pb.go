...
func (*ScheduleDeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptor26, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_delete_response.proto", fileDescriptor26) }
