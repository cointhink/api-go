...
func (*ScheduleDeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptor22, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_delete_response.proto", fileDescriptor22) }
