...
func (*ScheduleDeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule_delete_response.proto", fileDescriptor30) }
