...
func (Schedule_States) EnumDescriptor() ([]byte, []int) { return fileDescriptor20, []int{0, 0} }
...
func (*Schedule) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func init() { proto1.RegisterFile("proto/schedule.proto", fileDescriptor20) }
